...
including agriculture, mining and power. Population and industrial growth, along with climate change, are beginning to stress
water supplies. Between 1994 and 1999, 26\% of Canadian municipalities reported water shortages despite the fact that Canada
contains 9\% of the world's renewable water supply \cite{atlas_canada}.
...
have set up around 11,000 monitoring stations across North America \cite{wagner2006guidelines}, many of them reporting telemetry data in real-time. Analyzing this
...
The result is a fast, efficient method for data-stream prediction
that can manage a
