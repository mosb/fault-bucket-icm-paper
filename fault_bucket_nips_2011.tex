...
% where we have
% \begin{align}
% \amean{f\st}{\vy_{a}} \defequal {}& K_{\star,a} \tilde{V}_a^{-1} \vy_a,\label{eq:ameana}\\
% \acov{f\st}{\vy_{a}}
...
where we have
\begin{align*}
% \amean{f\st}{\vy_{a,b}} \defequal {}&  %\label{eq:ameanab}
% \\
% \acov{f\st}{\vy_{a}}
% \defequal {} &  \\%\label{eq:acovab}
% % \end{align*}
% % \vspace{-0.8cm}
% % \begin{align*}
...
& \sum_{j} \Prob{\vs^j_{b}}{\vy_{a,b}} (\hat{V}_{a,b}^{j})^{-1}\vy_{a,b}^{\phantom{\tr}} \vy_{a,b}^\tr (\hat{V}_{a,b}^{i,j})^{-1}\,.%\label{eq:Wab}
\end{align*}
