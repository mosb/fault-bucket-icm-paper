...
\item \label{app:single_gaussian} {\bf Single-Gaussian marginal:} Sums of Gaussians weighted by the posterior probabilities of faultiness of old data are approximated as single moment-matched Gaussians.
