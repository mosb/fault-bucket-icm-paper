...
[ /Author (Michael Osborne, Roman Garnett, Kevin Swersky, Nando de Freitas)
/Title (Prediction and Fault Detection of Environmental Signals with Uncharacterised Faults)
/Subject (Proceedings of the Twenty-Sixth AAAI Conference on Artificial Intelligence (AAAI-12))
/Keywords (Fault detection, Water sustainability, Gaussian processes, Novelty detection, Anomaly detection)
/DOCINFO pdfmark
}
...
\bibitem[\protect\citeauthoryear{Chandola, Banerjee, and
  Kumar}{2009}]{Chandola:2009}
Chandola, V.; Banerjee, A.; and Kumar, V.
\newblock 2009.
\newblock Anomaly detection: A survey.
\newblock {\em {\scshape acm} Comput. Surv.} 41:15:1--15:58.

\bibitem[\protect\citeauthoryear{de Freitas, MacLeod, and
  Maltz}{1996}]{deFreitas1996}
de~Freitas, N.; MacLeod, I.~M.; and Maltz, J.~S.
\newblock 1996.
\newblock Neural networks for pneumatic actuator fault detection.
\newblock {\em Transactions of the South African Institute of Electrical
  Engineers} 90:28--34.

\bibitem[\protect\citeauthoryear{Dereszynski and
  Dietterich}{2011}]{Dereszynski}
Dereszynski, E., and Dietterich, T.~G.
\newblock 2011.
\newblock Spatiotemporal models for anomaly detection in dynamic environmental
  monitoring campaigns.
\newblock {\em ACM Transactions on Sensor Networks}.

\bibitem[\protect\citeauthoryear{Ding}{2008}]{Ding2008}
Ding, S.~X.
\newblock 2008.
\newblock {\em Model-based Fault Diagnosis Techniques: Design Schemes,
  Algorithms, and Tools}.
\newblock Springer, first edition.

\bibitem[\protect\citeauthoryear{Eciolaza \bgroup et al.\egroup
  }{2007}]{Eciolaza2001}
Eciolaza, L.; Alkarouri, M.; Lawrence, N.~D.; Kadirkamanathan, V.; and Fleming,
  P.~J.
\newblock 2007.
\newblock {Gaussian Process Latent Variable Models for Fault Detection}.
\newblock In {\em \acro{ieee} Symposium on Computational Intelligence and Data
  Mining},  287---292.

\bibitem[\protect\citeauthoryear{{Environment Canada}}{2008}]{atlas_canada}
{Environment Canada}.
\newblock 2008.
\newblock {Threats to Water Availability in Canada}.

\bibitem[\protect\citeauthoryear{Garnett \bgroup et al.\egroup
  }{2010}]{garnettosborne}
Garnett, R.; Osborne, M.~A.; Reece, S.; Rogers, A.; and Roberts, S.~J.
\newblock 2010.
\newblock {Sequential Bayesian Prediction in the Presence of Changepoints and
  Faults}.
\newblock {\em The Computer Journal} 53.

\bibitem[\protect\citeauthoryear{Isermann}{2005}]{Isermann2005}
Isermann, R.
\newblock 2005.
\newblock Model-based fault-detection and diagnosis -- status and applications.
\newblock {\em Annual Reviews in Control} 29(1):71--85.

\bibitem[\protect\citeauthoryear{Kersting \bgroup et al.\egroup
  }{2007}]{kersting2007most}
...
\bibitem[\protect\citeauthoryear{Khan and Madden}{2010}]{Khan2010}
Khan, S., and Madden, M.
\newblock 2010.
...
\bibitem[\protect\citeauthoryear{Markou and Singh}{2003}]{Markou2003}
...
\bibitem[\protect\citeauthoryear{Minka}{2001}]{minka2001expectation}
Minka, T.
\newblock 2001.
...
\bibitem[\protect\citeauthoryear{Murphy}{1998}]{murphy1998switching}
Murphy, K.
\newblock 1998.
\newblock Switching {K}alman filters.
\newblock Technical report, {Compaq Cambridge Research Lab Tech Report 98-10}.

\bibitem[\protect\citeauthoryear{Naish-Guzman and
  Holden}{2008}]{naish2008robust}
...
\bibitem[\protect\citeauthoryear{Osborne \bgroup et al.\egroup
  }{2008}]{OsborneIPSN}
...
\bibitem[\protect\citeauthoryear{Rasmussen and Ghahramani}{2003}]{BZMonteCarlo}
...
\bibitem[\protect\citeauthoryear{Rasmussen and Williams}{2006}]{gpml}
...
\bibitem[\protect\citeauthoryear{Vanhatalo, Jyl{\"a}nki, and
  Vehtari}{2009}]{vanhatalo2009gaussian}
...
\bibitem[\protect\citeauthoryear{Wagner and {{\scshape us} Geological
  Survey}}{2006}]{wagner2006guidelines}
Wagner, R.~J., and {{\scshape us} Geological Survey}.
\newblock 2006.
\newblock {\em {Guidelines and standard procedures for continuous water-quality
  monitors: Station operation, record computation, and data reporting}}.
\newblock {\scshape us} Department of the Interior, {\scshape us} Geological
  Survey.
