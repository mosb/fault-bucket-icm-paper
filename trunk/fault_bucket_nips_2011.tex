...
\begin{figure*}[t!]
\begin{center}
 \includegraphics[width=\textwidth]{watermonitoring.eps}
\end{center}
...
fault-bucket algorithm and the exhuastive alternative on the two real datasets. The fault-bucket algorithm did an excellent
