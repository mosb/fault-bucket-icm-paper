...
p\bigl(\fault(\data_b) \given \data_{a,b}\bigr) = \Prob{\sigma_b =
  \sigma_f}{\data_{a,b}} $. Moving on, we define
\begin{align*}
...
Our first synthetic example, a bias fault, concerns a simple sensor error where
...
In the synthetic anomaly dataset, the water level rises quickly, but smoothly, before
