...
\icmlauthor{Michael Osborne*}{mosb@robots.ox.ac.uk}
\icmlauthor{Roman Garnett$\star$}{rgarnett@andrew.cmu.edu}
\icmlauthor{Kevin Swersky$\dagger$}{kevin@aquaticinformatics.com}
\icmlauthor{Nande de Freitas$\ddagger$}{nando@cs.ubc.ca}
\icmladdress{*Department of Computer Science, Oxford University \vspace{-10pt}}
\icmladdress{$\star$Department of Computer Science, Carnegie Mellon University \vspace{-10pt}}
\icmladdress{$\dagger$Aquatic Informatics \vspace{-10pt}}
\icmladdress{$\ddagger$Department of Computer Science, University of British Columbia}
